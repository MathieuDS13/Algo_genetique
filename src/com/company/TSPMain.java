...
public class TSPMain {
    ...
    public static void main(String[] args) {
        ...
        // a vous de jouer !
        AlgoGenTSP gen = new AlgoGenTSP(distances, nombreVilles, 1000); //TODO 100 pour le moment
        gen.solveByCyle(1000, 0.3, 0.05, 3);
    ...
    public static void genererDistance(int distances[][], int nombreVilles) {
        for (int x = 0; x < nombreVilles; x++)
            for (int y = 0; y < nombreVilles; y++)
                if (x == y) {
                    distances[x][y] = 0;
                } else distances[x][y] = (int) (Math.random() * 1000);
    }
